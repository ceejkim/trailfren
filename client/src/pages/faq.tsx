...
const FAQPage: FunctionComponent<FAQPageProps> = () => (
  <section>
    <div className="mx-auto mt-20 flex max flex-col max-w-2xl justify-center">
      ...
      <p className="m-8 text-base font-light leading-relaxed">
        ...
        Our friendly user experience and low maintenance tech make us simple to
        set up and easy to use. No training staff required!
      </p>
      <p className="mx-8 my-0 text-xl font-medium leading-relaxed">
