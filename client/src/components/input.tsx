...
const styles = {
  ...
  "bottom-border":
    "mb-1 h-9 w-full border-b border-gray-300 px-2 py-1 text-xs transition-opacity duration-1000 ease-out focus:border-b-2 focus:border-white focus:bg-gray-100 focus:outline-black",
};
const largeStyles = {
  "full-border":
